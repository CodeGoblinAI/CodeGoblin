...
<html>
  <head>
    <title>CodeGoblin - Codex Authorization Successful</title>
    <style>
      body {
        font-family:
          system-ui,
  ...
  <body>
    <div class="container">
      ...
      <p>You can close this window and return to CodeGoblin.</p>
    </div>
    <script>
...
<html>
  <head>
    <title>CodeGoblin - Codex Authorization Failed</title>
    <style>
      body {
        font-family:
          system-ui,
