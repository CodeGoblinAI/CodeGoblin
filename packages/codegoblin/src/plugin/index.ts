...
import { AnthropicCliAuthPlugin, AntigravityCliAuthPlugin, CursorAgentCliAuthPlugin } from "./cli-agent"
...
export class Service extends Context.Service<Service, Interface>()("@codegoblin/Plugin") {}
