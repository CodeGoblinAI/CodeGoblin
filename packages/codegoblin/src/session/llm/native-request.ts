import type { JsonSchema, LLMRequest, ProviderMetadata } from "@codegoblin/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@codegoblin/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @codegoblin/llm request objects from CodeGoblin's session/AI SDK-shaped data.
  return LLM.request({
