...
import type { LLMEvent } from "@codegoblin/llm"
import { LLMClient, RequestExecutor, WebSocketExecutor } from "@codegoblin/llm/route"
import type { LLMClientService } from "@codegoblin/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@codegoblin/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // Runtime seam: native is an opt-in adapter over @codegoblin/llm. It
