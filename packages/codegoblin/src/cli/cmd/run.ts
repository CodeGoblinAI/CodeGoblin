// CLI entry point for `cg run` / `codegoblin run`.
//
// Handles three modes:
...
//      CodeGoblin server and runs interactive mode against it.
//
...
import { createOpencodeClient, type OpencodeClient, type ToolPart } from "@codegoblin/sdk/v2"
...
export const RunCommand = effectCmd({
  command: "run [message..]",
  describe: "run CodeGoblin with a message",
