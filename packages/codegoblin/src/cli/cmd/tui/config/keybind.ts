...
import type { DeepMutable } from "@codegoblin/core/schema"
...
export const Definitions = {
  ...
  command_list: keybind(["ctrl+g", "ctrl+shift+g"], "Open the action palette"),
  ...
  variant_cycle: keybind("ctrl+t", "Switch model variant"),
  ...
  messages_first: keybind("ctrl+home", "Navigate to first message"),
  ...
  messages_last_user: keybind("ctrl+shift+down", "Navigate to last user message"),
  ...
  // ctrl+e (the Grok Build convention) is taken by input_line_end, so ctrl+o.
  display_thinking: keybind("ctrl+o", "Toggle thinking blocks visibility"),
  ...
  input_newline: keybind("ctrl+j,shift+return,ctrl+return,alt+return", "Insert newline in input"),
  ...
  // "none" by default: <leader>h was double-booked with messages_toggle_conceal
  // (session-scoped). Still reachable via the palette/tips.toggle command.
