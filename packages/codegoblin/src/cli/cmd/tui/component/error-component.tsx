...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/CodeGoblinAI/CodeGoblin/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("codegoblin-version", InstallationVersion)
