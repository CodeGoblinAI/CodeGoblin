...
function TuiSidebarCompanionGoblin(props: {
  ...
  const chatGoblinVariants: ChatGoblinVariant[] = [
    ...
    createChatGoblinVariant("41", "warden", [
      "....GGGGGGGG....",
      "..GGGGGGGGGGGG..",
      "G.GGGGGGGGGGGG.G",
      ".GGGGGGGGGGGGGG.",
    ...
    createChatGoblinVariant("42", "sprout", [
      ".....GGGGGG.....",
      "...GGGGGGGGGG...",
      "..GGGGGGGGGGGG..",
      "..GGBBGGGGBBGG..",
    ...
    createChatGoblinVariant("43", "spike", [
      "..G...G...G.....",
      "..GG.GGG.GG.....",
      ".GGGGGGGGGGGG...",
      ".GGGGGGGGGGGG...",
    ...
    createChatGoblinVariant("44", "hooded", [
      "...PPPPPPPP.....",
      "..PPGGGGGGPP....",
      ".PPGGGGGGGGPP...",
      ".PGGBBGGBBGGP...",
    ...
    createChatGoblinVariant("45", "grin", [
      "...GGGGGGGGGG...",
      ".GGGGGGGGGGGGGG.",
      "GGGGGGGGGGGGGGGG",
      "GGGBBGGGGGGBBGGG",
