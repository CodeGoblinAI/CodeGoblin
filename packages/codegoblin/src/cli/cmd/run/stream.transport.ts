...
import type { Event, GlobalEvent, OpencodeClient } from "@codegoblin/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@codegoblin/RunStreamTransport") {}
