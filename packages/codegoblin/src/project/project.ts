...
import { Project as ProjectV2 } from "@codegoblin/core/project"
import { CrossSpawnSpawner } from "@codegoblin/core/cross-spawn-spawner"
import { AbsolutePath, NonNegativeInt, optionalOmitUndefined } from "@codegoblin/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@codegoblin/Project") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(ProjectVcs))(Flag.CODEGOBLIN_FAKE_VCS)
