...
import { InstallationLocal, InstallationVersion } from "@codegoblin/core/installation/version"
...
import { EffectFlock } from "@codegoblin/core/util/effect-flock"
import { containsPath, type InstanceContext } from "../project/instance-context"
import { NonNegativeInt, PositiveInt, type DeepMutable } from "@codegoblin/core/schema"
...
function normalizeLoadedConfig(data: unknown, source: string) {
  ...
  delete copy.tui
  log.warn("tui keys in CodeGoblin config are deprecated; move them to tui.json", { path: source })
  return copy
}
...
export const Info = Schema.Struct({
  ...
  server: Schema.optional(ConfigServer.Server).annotate({
    description: "Server configuration for CodeGoblin serve and web commands",
  }),
  command: Schema.optional(Schema.Record(Schema.String, ConfigCommand.Info)).annotate({
    description: "Command configuration for CodeGoblin custom commands",
  }),
  ...
  ).annotate({ description: "Agent configuration for CodeGoblin/OpenCode-compatible agents" }),
...
// Uses the shared `DeepMutable` from `@codegoblin/core/schema`. See the definition
...
export class Service extends Context.Service<Service, Interface>()("@codegoblin/Config") {}
    ...
    const loadInstanceState = Effect.fn("Config.loadInstanceState")(
      function* (ctx: InstanceContext) {
        ...
        if (existsSync(managedDir)) {
          for (const file of ["opencode.json", "opencode.jsonc", "codegoblin.json", "codegoblin.jsonc"]) {
