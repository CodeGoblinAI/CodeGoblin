 ...
 *   "@codegoblin/ServerAuthConfig",
 *   {
 *     password: Config.string("CODEGOBLIN_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CODEGOBLIN_SERVER_USERNAME").pipe(Config.withDefault("codegoblin")),
 *   },
 * ) {}
 *
