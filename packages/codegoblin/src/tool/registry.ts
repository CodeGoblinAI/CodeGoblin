...
import { type ToolContext as PluginToolContext, type ToolDefinition } from "@codegoblin/plugin"
...
export class Service extends Context.Service<Service, Interface>()("@codegoblin/ToolRegistry") {}
