import type * as SDK from "@codegoblin/sdk/v2"
...
const disabled = (process.env["CODEGOBLIN_DISABLE_SHARE"] ?? process.env["OPENCODE_DISABLE_SHARE"]) === "true" || (process.env["CODEGOBLIN_DISABLE_SHARE"] ?? process.env["OPENCODE_DISABLE_SHARE"]) === "1"
...
export class Service extends Context.Service<Service, Interface>()("@codegoblin/ShareNext") {}
