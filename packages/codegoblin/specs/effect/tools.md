...
Practical reference for the current tool-migration state in `packages/codegoblin`.
...
Tool tests should use the existing Effect helpers in `packages/codegoblin/test/lib/effect.ts`:
