  ...
  },
  {
    ...
    items: [
      ...
      { type: "separator" },
      {
        ...
        href: "https://github.com/CodeGoblinAI/CodeGoblin/issues/new?template=feature-request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/CodeGoblinAI/CodeGoblin/issues/new?template=bug-report.yml",
      },
    ],
  },
]
