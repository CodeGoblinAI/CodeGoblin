  ...
  return (
    <Show when={props.popover}>
      <div
        ...
        class="max-h-[min(20rem,calc(100dvh-8rem))] min-h-10
        ...
        classList={{
          "absolute inset-x-0 -top-2 -translate-y-full origin-bottom-left": props.placement === "above",
          "relative order-2 mt-2 origin-top-left": props.placement === "below",
        }}
