  ...
  return (
    <Show when={props.popover}>
      <div
        ...
        class="absolute inset-x-0 max-h-[min(20rem,calc(100dvh-8rem))] min-h-10
        ...
        classList={{
          "-top-2 -translate-y-full origin-bottom-left": props.placement === "above",
          "top-full mt-2 origin-top-left": props.placement === "below",
        }}
