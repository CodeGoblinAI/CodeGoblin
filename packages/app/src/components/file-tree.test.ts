...
beforeAll(async () => {
  ...
  mock.module("@codegoblin/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@codegoblin/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@codegoblin/ui/icon", () => ({ Icon: () => null }))
  mock.module("@codegoblin/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
