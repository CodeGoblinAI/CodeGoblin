...
import { Session, type Message } from "@codegoblin/sdk/v2/client"
...
import { showToast, Toast, toaster } from "@codegoblin/ui/toast"
...
import { retry } from "@codegoblin/core/util/retry"
...
import { useTheme, type ColorScheme } from "@codegoblin/ui/theme/context"
  ...
  command.register("layout", () => {
    const commands: CommandOption[] = [
      ...
      sharedSlash("usage", {
        ...
        title: "View usage",
        onSelect: () => {
          void import("@/components/dialog-usage").then((x) =>
            dialog.show(() => <x.DialogUsage sessionID={params.id} directory={currentDir()} />),
          )
        },
      }),
      sharedSlash("status", {
