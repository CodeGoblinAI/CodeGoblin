...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "CodeGoblin tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve CodeGoblin'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve CodeGoblin'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak CodeGoblin'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi CodeGoblin sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "CodeGoblin'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı CodeGoblin ekibine bildirin",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: CodeGoblin henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "CodeGoblin ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "CodeGoblin Masaüstü",
  ...
  "settings.desktop.wsl.description": "CodeGoblin sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "CodeGoblin'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "CodeGoblin'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "CodeGoblin'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "CodeGoblin'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "CodeGoblin başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "CodeGoblin'un en son sürümünü kullanıyorsunuz.",
