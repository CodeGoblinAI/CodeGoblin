export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez CodeGoblin",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w CodeGoblin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w CodeGoblin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w CodeGoblin.",
  ...
  "dialog.server.description": "Przełącz serwer CodeGoblin, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja CodeGoblin ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu CodeGoblin",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CodeGoblin does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "CodeGoblin zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla CodeGoblin",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd CodeGoblin na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy CodeGoblin ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw CodeGoblin.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CodeGoblin",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CodeGoblin.",
