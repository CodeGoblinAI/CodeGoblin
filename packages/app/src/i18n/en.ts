export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models available in CodeGoblin",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in CodeGoblin.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in CodeGoblin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in CodeGoblin.",
  ...
  "dialog.server.description": "Switch which CodeGoblin server this app connects to.",
  ...
  "toast.permissions.autoaccept.on.description": "Permission requests get waved through automatically",
  ...
  "toast.update.description": "A new version of CodeGoblin ({{version}}) is now available to install.",
  ...
  "home.empty.title": "No hoard yet",
  "home.empty.description": "Open a local project and let the goblin start working",
  "home.title": "Home",
  "home.projects": "Project hoard",
  "home.project.add": "Add project",
  "home.sessions.search.placeholder": "Search goblin sessions",
  "home.sessions.empty": "No sessions in the hoard",
  ...
  "session.panel.toggle": "Toggle panel",
  "session.panel.hide": "Hide panel",
  "session.panel.show": "Show panel",
  ...
  "sidebar.gettingStarted.line1": "CodeGoblin keeps provider keys local and preserves BYOK model support.",
  "sidebar.gettingStarted.line2": "Use Gemini or xAI image models to save generated images locally.",
  ...
  "app.name.desktop": "CodeGoblin Desktop",
  ...
  "settings.general.section.sounds": "Sounds & chimes",
  "settings.general.section.feed": "Feed",
  "settings.general.section.display": "Layout",

  "settings.general.row.language.title": "Language",
  "settings.general.row.language.description": "Pick the language CodeGoblin speaks to you in",
  ...
  "settings.general.row.audioAutoApprove.title": "Skip audio confirmations",
  "settings.general.row.audioAutoApprove.description":
    "Reuse your last voice, format, and tuning and skip the audio confirm step.",
  "settings.general.row.model3dAutoApprove.title": "Skip 3D confirmations",
  "settings.general.row.model3dAutoApprove.description":
    "Reuse your last Tripo model version and output format and skip the confirm step.",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how CodeGoblin looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether CodeGoblin follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how CodeGoblin is themed.",
  ...
  "settings.general.row.reasoningSummaries.title": "Show reasoning notes",
  "settings.general.row.reasoningSummaries.description": "Surface the model's reasoning notes in the timeline",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CodeGoblin launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of CodeGoblin.",
