...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/share{/highlight} to create a public upstream OpenCode share link",
  ...
  "Create {highlight}opencode.json{/highlight} for compatibility server settings and {highlight}tui.json{/highlight} for TUI settings",
  ...
  "Run {highlight}codegoblin upgrade{/highlight} to update to the latest version",
  ...
  "Use {highlight}/codegoblin{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}codegoblin github install{/highlight} to set up the GitHub workflow",
  "Comment {highlight}/codegoblin fix this{/highlight} on issues to auto-create PRs",
  ...
  "Use the upstream OpenCode container only when you intentionally want the unmodified upstream image",
  "Use {highlight}/connect{/highlight} with upstream hosted models or your own API keys",
