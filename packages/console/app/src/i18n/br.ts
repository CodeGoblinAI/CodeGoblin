...
export const dict = {
  ...
  "app.meta.description": "CodeGoblin - O agente de codificação de código aberto.",

  "home.title": "CodeGoblin | O agente de codificação de código aberto com IA",
  ...
  "temp.screenshot.caption": "CodeGoblin TUI com o tema tokyonight",
  "temp.screenshot.alt": "CodeGoblin TUI com tema tokyonight",
  ...
  "home.what.title": "O que é CodeGoblin?",
  "home.what.body":
    "CodeGoblin é um agente de código aberto que ajuda você a escrever código no seu terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Com mais de <strong>{{stars}}</strong> estrelas no GitHub, <strong>{{contributors}}</strong> colaboradores e mais de <strong>{{commits}}</strong> commits, CodeGoblin é usado e confiado por mais de <strong>{{monthlyUsers}}</strong> desenvolvedores todos os meses.",
  ...
  "home.privacy.body":
    "CodeGoblin não armazena nenhum código seu nem dados de contexto, para que possa operar em ambientes sensíveis à privacidade.",
  "home.privacy.learnMore": "Saiba mais sobre",
  "home.privacy.link": "privacidade",

  "home.faq.q1": "O que é CodeGoblin?",
  "home.faq.a1":
    "CodeGoblin é um agente de código aberto que ajuda você a escrever e executar código com qualquer modelo de IA. Está disponível como interface de terminal, app desktop ou extensão de IDE.",
  "home.faq.q2": "Como eu uso o CodeGoblin?",
  "home.faq.a2.before": "A maneira mais fácil de começar é ler a",
  "home.faq.a2.link": "introdução",
  "home.faq.q3": "Preciso de assinaturas extras de IA para usar o CodeGoblin?",
  "home.faq.a3.p1":
    "Não necessariamente, CodeGoblin vem com um conjunto de modelos grátis que você pode usar sem criar conta.",
  "home.faq.a3.p2.beforeZen":
    "Além disso, você pode usar qualquer um dos modelos de codificação populares criando uma conta",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Embora incentivemos os usuários a usar o Zen, CodeGoblin também funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Você pode até conectar seus",
  "home.faq.a3.p4.localLink": "modelos locais",
  "home.faq.q4": "Posso usar minhas assinaturas de IA existentes com o CodeGoblin?",
  "home.faq.a4.p1":
    "Sim, CodeGoblin suporta planos de assinatura de todos os principais provedores. Você pode usar suas assinaturas Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Posso usar o CodeGoblin apenas no terminal?",
  "home.faq.a5.beforeDesktop": "Não mais! CodeGoblin agora está disponível como um app para o seu",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto custa o CodeGoblin?",
  "home.faq.a6":
    "CodeGoblin é 100% gratuito para usar. Ele também vem com um conjunto de modelos gratuitos. Pode haver custos adicionais se você conectar qualquer outro provedor.",
  ...
  "home.faq.q8": "CodeGoblin é código aberto?",
  "home.faq.a8.p1": "Sim, CodeGoblin é totalmente open source. O código-fonte é público no",
  ...
  "home.zenCta.body":
    "O Zen dá acesso a um conjunto selecionado de modelos de IA que a CodeGoblin testou e avaliou especificamente para agentes de codificação. Não precisa se preocupar com desempenho e qualidade inconsistentes entre provedores, use modelos validados que funcionam.",
  ...
  "zen.hero.body":
    "O Zen dá acesso a um conjunto selecionado de modelos de IA que a CodeGoblin testou e avaliou especificamente para agentes de codificação. Não precisa se preocupar com desempenho e qualidade inconsistentes, use modelos validados que funcionam.",

  "zen.faq.q1": "O que é OpenCode Zen?",
  "zen.faq.a1":
    "Zen é um conjunto selecionado de modelos de IA testados e avaliados para agentes de codificação, criado pela equipe por trás do CodeGoblin.",
  ...
  "zen.faq.a3":
    "O Zen não tem fins lucrativos. O Zen repassa os custos dos provedores de modelos para você. Quanto maior o uso do Zen, mais a CodeGoblin pode negociar melhores taxas e repassá-las para você.",
  ...
  "zen.faq.a4.p3":
    "Para cobrir custos, a CodeGoblin adiciona apenas uma pequena taxa de processamento de pagamento de $1,23 por recarga de $20.",
  ...
  "zen.faq.a8":
    "Embora o Zen funcione muito bem com o CodeGoblin, você pode usar o Zen com qualquer agente. Siga as instruções de configuração no seu agente de codificação preferido.",
  ...
  "zen.problem.subtitle": "Estamos corrigindo isso para todos, não apenas para os usuários do CodeGoblin.",
  ...
  "zen.how.body": "Embora sugerimos que você use o Zen com o CodeGoblin, você pode usá-lo com qualquer agente.",
  ...
  "go.title": "CodeGoblin Go | Modelos de codificação de baixo custo para todos",
  "go.meta.description":
  ...
  "go.problem.body":
    "Estamos focados em levar a experiência do CodeGoblin para o maior número de pessoas possível. CodeGoblin Go é uma assinatura de baixo custo: $5 no primeiro mês, depois $10/mês. Oferece limites generosos e acesso confiável aos modelos open source mais capazes.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body":
    "O Go começa em $5 no primeiro mês, depois $10/mês. Você pode usá-lo com o CodeGoblin ou qualquer agente.",
  ...
  "go.faq.q1": "O que é CodeGoblin Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "A promoção gratuita do {{model}} terminou. Você pode continuar usando o modelo assinando o CodeGoblin Go - {{link}}",

  "black.meta.title": "CodeGoblin Black | Acesse os melhores modelos de codificação do mundo",
  "black.meta.description": "Tenha acesso ao Claude, GPT, Gemini e mais com os planos de assinatura CodeGoblin Black.",
  ...
  "black.title": "CodeGoblin Black | Preços",
  ...
  "black.workspace.title": "CodeGoblin Black | Selecionar Workspace",
  "black.workspace.selectPlan": "Selecione um workspace para este plano",
  "black.workspace.name": "Workspace {{n}}",
  "black.subscribe.title": "Assinar CodeGoblin Black",
  ...
  "black.subscribe.success.title": "Você está na lista de espera do CodeGoblin Black",
  ...
  "workspace.black.subscription.message": "Você assina o CodeGoblin Black por ${{plan}} por mês.",
  ...
  "workspace.black.waitlist.joined": "Você está na lista de espera para o plano CodeGoblin Black de ${{plan}} por mês.",
  "workspace.black.waitlist.ready": "Estamos prontos para inscrever você no plano CodeGoblin Black de ${{plan}} por mês.",
  ...
  "workspace.lite.subscription.message": "Você assina o CodeGoblin Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecione "CodeGoblin Go" como provedor na sua configuração do opencode para usar os modelos Go.',
  "workspace.lite.black.message":
    "Você está atualmente inscrito no CodeGoblin Black ou na lista de espera. Por favor, cancele a assinatura primeiro se desejar mudar para o Go.",
  "workspace.lite.other.message":
    "Outro membro neste workspace já assina o CodeGoblin Go. Apenas um membro por workspace pode assinar.",
  "workspace.lite.promo.description":
    "O CodeGoblin Go começa em {{price}}, depois $10/mês, e oferece acesso confiável a modelos de codificação abertos populares com limites de uso generosos.",
  ...
  "download.title": "CodeGoblin | Baixar",
  "download.meta.description": "Baixe o CodeGoblin para macOS, Windows e Linux",
  "download.hero.title": "Baixar CodeGoblin",
  ...
  "download.section.extensions": "Extensões CodeGoblin",
  "download.section.integrations": "Integrações CodeGoblin",
  ...
  "download.faq.a3.beforeLocal":
    "Não necessariamente, mas provavelmente. Você precisará de uma assinatura de IA se quiser conectar o CodeGoblin a um provedor pago, embora você possa trabalhar com",
  ...
  "download.faq.a3.afterZen":
    ", o CodeGoblin funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "O CodeGoblin é 100% gratuito para usar.",
  "download.faq.a5.p2.beforeZen":
    "Quaisquer custos adicionais virão da sua assinatura de um provedor de modelo. Embora o CodeGoblin funcione com qualquer provedor de modelo, recomendamos o uso do",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Seus dados e informações só são armazenados quando você cria links compartilháveis no CodeGoblin.",
  "download.faq.a6.p2.beforeShare": "Saiba mais sobre",
  "download.faq.a6.shareLink": "páginas de compartilhamento",

  "enterprise.title": "CodeGoblin | Soluções empresariais para sua organização",
  "enterprise.meta.description": "Contate a CodeGoblin para soluções empresariais",
  "enterprise.hero.title": "Seu código é seu",
  "enterprise.hero.body1":
    "O CodeGoblin opera com segurança dentro da sua organização, sem dados ou contexto armazenados e sem restrições de licenciamento ou reivindicações de propriedade. Inicie um teste com sua equipe e, em seguida, implante em toda a organização integrando-o ao seu SSO e gateway de IA interno.",
  ...
  "enterprise.faq.q1": "O que é CodeGoblin Enterprise?",
  "enterprise.faq.a1":
    "CodeGoblin Enterprise é para organizações que desejam garantir que seu código e dados nunca saiam de sua infraestrutura. Isso pode ser feito usando uma configuração centralizada que se integra ao seu SSO e gateway de IA interno.",
  "enterprise.faq.q2": "Como faço para começar com o CodeGoblin Enterprise?",
  "enterprise.faq.a2":
    "Basta começar com um teste interno com sua equipe. O CodeGoblin por padrão não armazena seu código ou dados de contexto, facilitando o início. Em seguida, entre em contato conosco para discutir opções de preços e implementação.",
  ...
  "enterprise.faq.q4": "Meus dados estão seguros com o CodeGoblin Enterprise?",
  "enterprise.faq.a4":
    "Sim. O CodeGoblin não armazena seu código ou dados de contexto. Todo o processamento acontece localmente ou por meio de chamadas de API diretas para seu provedor de IA. Com configuração centralizada e integração de SSO, seus dados permanecem seguros dentro da infraestrutura de sua organização.",

  "brand.title": "CodeGoblin | Marca",
  "brand.meta.description": "Diretrizes da marca CodeGoblin",
  "brand.heading": "Diretrizes da marca",
  "brand.subtitle": "Recursos e ativos para ajudá-lo a trabalhar com a marca CodeGoblin.",
  "brand.downloadAll": "Baixar todos os recursos",

  "changelog.title": "CodeGoblin | Changelog",
  "changelog.meta.description": "Notas de versão e changelog do CodeGoblin",
  "changelog.hero.title": "Changelog",
  "changelog.hero.subtitle": "Novas atualizações e melhorias no CodeGoblin",
