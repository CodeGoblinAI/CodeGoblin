...
class Database extends Context.Service<Database, DatabaseShape>()("@codegoblin/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@codegoblin/example/UserStore") {
